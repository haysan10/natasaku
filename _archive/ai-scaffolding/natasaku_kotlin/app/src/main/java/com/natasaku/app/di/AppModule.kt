...
object AppModule {
    ...
    @Provides fun provideScheduledPaymentDao(db: NataSakuDatabase): ScheduledPaymentDao = db.scheduledPaymentDao()
    @Provides fun provideScheduledPaymentExecutionDao(db: NataSakuDatabase): ScheduledPaymentExecutionDao = db.scheduledPaymentExecutionDao()
    @Provides fun provideScheduledSavingDao(db: NataSakuDatabase): ScheduledSavingDao = db.scheduledSavingDao()
    @Provides fun provideScheduledSavingExecutionDao(db: NataSakuDatabase): ScheduledSavingExecutionDao = db.scheduledSavingExecutionDao()
    ...
    fun provideBackupRestoreService(
        ...
        scheduledPaymentExecutionDao: ScheduledPaymentExecutionDao,
