...
6. Graphic assets:
   ...
   - Splash asset tersedia.
   - Welcome illustration tersedia.
   - Onboarding illustrations tersedia.
   - Empty state illustrations tersedia.
   - Export success illustration tersedia atau fallback acceptable.
   - Asset placement sesuai `GRAPHIC_ASSETS.md`.
