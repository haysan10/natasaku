...
- Jika track menyentuh UI/branding/illustration, baca `GRAPHIC_ASSETS.md`.
- Gunakan custom assets hanya untuk branding dan illustration yang memang didokumentasikan.
- Untuk action icons, navigation icons, category icons, dan status icons, gunakan Material Icons / Material Symbols.
- Jika asset final belum tersedia, gunakan placeholder dengan naming yang konsisten dan TODO jelas.
