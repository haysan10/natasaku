...
import com.natasaku.app.di.AppModule;
...
public final class NataSakuApplication_HiltComponents {
  private NataSakuApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements NataSakuApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          MonthlyReportViewModel_HiltModules.KeyModule.class,
          ActivityCBuilderModule.class,
          ViewModelCBuilderModule.class,
          SavingViewModel_HiltModules.KeyModule.class,
          SettingsViewModel_HiltModules.KeyModule.class,
          SetupViewModel_HiltModules.KeyModule.class,
          SplashViewModel_HiltModules.KeyModule.class,
          TransactionHistoryViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          MonthlyReportViewModel_HiltModules.BindsModule.class,
          SavingViewModel_HiltModules.BindsModule.class,
          SettingsViewModel_HiltModules.BindsModule.class,
          SetupViewModel_HiltModules.BindsModule.class,
          SplashViewModel_HiltModules.BindsModule.class,
          TransactionHistoryViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
