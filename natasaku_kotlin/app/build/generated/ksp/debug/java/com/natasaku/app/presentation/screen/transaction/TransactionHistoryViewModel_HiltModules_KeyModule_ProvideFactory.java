...
public final class TransactionHistoryViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  ...
  public static boolean provide() {
    return TransactionHistoryViewModel_HiltModules.KeyModule.provide();
  }

  private static final class InstanceHolder {
    private static final TransactionHistoryViewModel_HiltModules_KeyModule_ProvideFactory INSTANCE = new TransactionHistoryViewModel_HiltModules_KeyModule_ProvideFactory();
  }
}
