...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel get() {
    return newInstance(budgetPeriodDaoProvider.get(), transactionDaoProvider.get(), incomeSourceDaoProvider.get(), fixedExpenseDaoProvider.get(), savingTargetDaoProvider.get(), savingAllocationDaoProvider.get(), dailyBudgetSnapshotDaoProvider.get(), budgetCalculatorProvider.get(), dailyBudgetCalculatorProvider.get(), overbudgetCalculatorProvider.get());
  }
  ...
  public static HomeViewModel_Factory create(Provider<BudgetPeriodDao> budgetPeriodDaoProvider,
      ...
      Provider<DailyBudgetCalculator> dailyBudgetCalculatorProvider,
      Provider<OverbudgetCalculator> overbudgetCalculatorProvider) {
    return new HomeViewModel_Factory(budgetPeriodDaoProvider, transactionDaoProvider, incomeSourceDaoProvider, fixedExpenseDaoProvider, savingTargetDaoProvider, savingAllocationDaoProvider, dailyBudgetSnapshotDaoProvider, budgetCalculatorProvider, dailyBudgetCalculatorProvider, overbudgetCalculatorProvider);
  }
  ...
  public static HomeViewModel newInstance(BudgetPeriodDao budgetPeriodDao,
      ...
      SavingAllocationDao savingAllocationDao, DailyBudgetSnapshotDao dailyBudgetSnapshotDao,
      BudgetCalculator budgetCalculator, DailyBudgetCalculator dailyBudgetCalculator,
      OverbudgetCalculator overbudgetCalculator) {
    return new HomeViewModel(budgetPeriodDao, transactionDao, incomeSourceDao, fixedExpenseDao, savingTargetDao, savingAllocationDao, dailyBudgetSnapshotDao, budgetCalculator, dailyBudgetCalculator, overbudgetCalculator);
  }
}
