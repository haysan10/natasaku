...
7. Graphic assets:
   - Apakah penggunaan graphic asset mengikuti `GRAPHIC_ASSETS.md`?
   - Apakah custom asset hanya dipakai untuk branding/illustration yang memang perlu?
   - Apakah icon fungsi umum memakai Material Icons / Material Symbols?
   - Apakah asset disimpan di folder yang benar?
