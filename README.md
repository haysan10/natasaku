...
APK siap unduh tersedia di folder berikut:

- [downloads/natasaku-latest.apk](./downloads/natasaku-latest.apk)

Panduan instalasi singkat ada di [DISTRIBUTION_APK.md](./natasaku_flutter/DISTRIBUTION_APK.md).
APK juga bisa dibangun otomatis dari GitHub Actions workflow `Build Flutter APK`.
